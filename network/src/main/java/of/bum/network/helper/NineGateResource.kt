...
abstract class NineGateResource<RequestType> {
        ...
        result.addSource(apiResponse) {response ->
            ...
            when(response) {
                is ApiSuccessResponse -> {
                    ...
                    val unwrapped: RequestType? = response.body.wrap
    ...
    @MainThread
    protected abstract fun  createCall(): LiveData<ApiResponse<WrapBase<RequestType>>>
