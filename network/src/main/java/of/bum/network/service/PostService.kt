...
interface PostService {
    ...
    @GET("v1/api/social/{id}")
    fun getDetailPost(@Path("id") id: String): LiveData<ApiResponse<RestResponse<Post>>>

    @GET("v1/api/social/listparent/{id}")
    fun getCommentPost(@Path("id") id: String): LiveData<ApiResponse<RestResponse<Parent>>>

    @POST("/v1/api/social/post")
    fun postComment(@Body obj: RequestBody): LiveData<ApiResponse<RestResponse<List<Post>>>>
    ...
    @GET("v1/api/social/listing")
    fun getNewFeedPost(@Query("page") page :Int, @Query("limit") limit: Int): LiveData<ApiResponse<RestResponse<List<PostEntity>>>>
